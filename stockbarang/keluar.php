            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Pangan Keluar</h1>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <?php
                                         $ambilsemuadatakeluar = mysqli_query($conn,"select * from keluar k, penerima p where p.idpenerima = k.idpenerima");
                                         while($data=mysqli_fetch_array($ambilsemuadatakeluar)){
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Pengelolaan Pangan &copy; Pangan Keluar</div>
                            <div>
